...
Cite
--------------------
PyWIB was presented on the `IARIA Congress 2026 <https://www.thinkmind.org/conferences/iaria_congress_2026/>`_ and published in the proceedings of the conference :cite:p:`CarvajalAza2026PyWIB`, obtaining a `Best Paper Award <https://www.iaria.org/conferences2026/awardsIARIACongress26/congress2026_a4.pdf>`_.
If you use PyWIB in your research, we kindly ask you to cite us:
...
We suggest you take a deep look at rest of the documentation, such as the `Keyboard Interaction Metrics <keyboard.html>`_ or `Movement Interaction Metrics <movement.html>`_ sections in order to understand the different metrics that can be computed with **PyWIB** and find those that suit your research.
